...
reporting.controller('Reporting', ['$scope', 'appManager', '$state', '$mdDialog', '$mdPanel', function ($scope, appManager, $state, $mdDialog, $mdPanel) {
    ...
    $scope.reports = [
        ...
        [{ "Report_Name": "Dashboard", "Position": 100, "Category": "Summary Reports", }],
        [
        { "Report_Name": "Metric 1", "Position": 100, "Category": "Detail Reports" },
        { "Report_Name": "Metric 2", "Position": 100, "Category": "Detail Reports" },
        { "Report_Name": "Metric 3", "Position": 100, "Category": "Detail Reports" },
        { "Report_Name": "Metric 4", "Position": 100, "Category": "Detail Reports" },
        { "Report_Name": "Metric 5", "Position": 100, "Category": "Detail Reports" },
        { "Report_Name": "Metric 6", "Position": 100, "Category": "Detail Reports" },
        { "Report_Name": "Metric 7", "Position": 100, "Category": "Detail Reports" },
        { "Report_Name": "Metric 8", "Position": 100, "Category": "Detail Reports" }
        ]
